...
export function ProductDetail({name, price, category, rating, brandName, bulkPrice, totalCost, availableQuantity, minOrderQuantity, estimatedDelivery, sellerPincode, shippingCost, userRating }) {
  return (
    <div>
        <Topbar/>
