...
import cloves from '../assets/products/cloves.png'
import blackpepper from '../assets/products/blackpepper.png'
import paprika from '../assets/products/paprika.png'
    ...
    <section className="py-12 bg-white sm:py-16 lg:py-2">
        <div className=" shadow-2xl relative">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
                <h1 className="absolute bottom-0 left-0 right-0 text-4xl font-mono mb-10 font-bold text-center text-white p-4d">Welcome to the garden of Indian spices !</h1>
            </div>
        </div>
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        
        <h2 className="text-2xl font-bold text-gray-900 mt-10 sm:text-3xl bg-re py-2 px-3 shadow-lg">Our featured items</h2>
        ...
        <div className="grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4 mb-10">
            ...
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <img className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src={paprika} alt="" />
                </div>
                <div className="flex items-start justify-between mt-4 space-x-4">
                    <div>
                        <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">
            ...
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <img className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src={cloves} alt="" />
                </div>
                <div className="absolute left-3 top-3">
            ...
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1">
                    <img className="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src={blackpepper} alt="" />
                </div>
                <div className="flex items-start justify-between mt-4 space-x-4">
                    <div>
                        <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">
