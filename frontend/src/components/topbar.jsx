...
export function Topbar({name}){
    return(
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Shri ORGANIC</span>

        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button" class="flex text-sm bg-black rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        ...
        export function LogoutButton(){
            ...
            return(
                <div>
                   <button className="border border-white text-white mt-5 py-2 px-2 rounded-lg text-sm font-mono hover:bg-red-500 hover:text-black" onClick={()=> {
